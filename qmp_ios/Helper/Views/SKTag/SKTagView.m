...
@property (strong, nonatomic, nullable) SKTagButton *selectedBtn;
...
- (void)onTag: (SKTagButton *)btn {
    if (self.selectedBtn) {
        [self.selectedBtn setTitleColor:HTColorFromRGB(0x555555) forState:UIControlStateNormal];
        self.selectedBtn.layer.borderColor =  BORDER_LINE_COLOR.CGColor;
    }
