...
- (void)strokePath{
    ...
    for (NSInteger i = 0; i < _sectionCount; i++) {
        ...
        if (_radarPatternType == kRadarPatternTypeCircle) {
            [self.layer addSublayer:[self circleShapeLayer:i]];
            [self.layer addSublayer:[self circleLineShapeLayer:i]];
        }
//        _radarPatternType == kRadarPatternTypeCircle ? [self.layer addSublayer:[self circleShapeLayer:i]] : ();
//        _radarPatternType == kRadarPatternTypeCircle ? [self.layer addSublayer:[self circleLineShapeLayer:i]] : ();
    }
