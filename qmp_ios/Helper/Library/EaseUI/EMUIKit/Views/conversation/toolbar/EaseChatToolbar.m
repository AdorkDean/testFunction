...
//    _backgroundImageView.image = [[UIImage imageNamed:@"EaseUIResource.bundle/messageToolbarBg"] stretchableImageWithLeftCapWidth:0.5 topCapHeight:10];
    _backgroundImageView.image = [[UIImage imageFromColor:[UIColor whiteColor] andSize:_backgroundImageView.frame.size] stretchableImageWithLeftCapWidth:0.5 topCapHeight:10];
    ...
    _toolbarBackgroundImageView = [[UIImageView alloc] initWithFrame:CGRectMake(-1, 0, _toolbarView.frame.size.width+2, _toolbarView.frame.size.height)];
    ...
    _toolbarBackgroundImageView.layer.borderWidth = 0.5;
    _toolbarBackgroundImageView.layer.borderColor = HTColorFromRGB(0xeeeeee).CGColor;
    ...
    _inputTextView.layer.borderColor = HTColorFromRGB(0xF0F0F0).CGColor;
...
//    _inputTextView.layer.borderWidth = 0;
    ...
    self.recordButton.layer.borderColor = HTColorFromRGB(0xdbdbdb).CGColor;
...
//    [self.recordButton setBackgroundImage:[[UIImage imageNamed:@"EaseUIResource.bundle/chatBar_recordSelectedBg"] stretchableImageWithLeftCapWidth:10 topCapHeight:10] forState:UIControlStateHighlighted];
    [self.recordButton setBackgroundImage:[[UIImage imageFromColor:HTColorFromRGB(0xffffff) andSize:self.recordButton.frame.size] stretchableImageWithLeftCapWidth:10 topCapHeight:10] forState:UIControlStateNormal];
    [self.recordButton setBackgroundImage:[[UIImage imageFromColor:HTColorFromRGB(0xf1f1f1) andSize:self.recordButton.frame.size] stretchableImageWithLeftCapWidth:10 topCapHeight:10] forState:UIControlStateHighlighted];
