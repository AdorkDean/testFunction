...
#define CHAT_BUTTON_SIZE CGSizeMake(55,75)
#define INSETS 10
...
- (void)setupSubviewsForType:(EMChatToolbarType)type
{
    ...
    CGFloat insets = (self.frame.size.width - 3 * CHAT_BUTTON_SIZE.width) / 4;

    _photoButton = [self btnWithImage:[UIImage imageNamed:@"EaseUIResource.bundle/chatBar_colorMore_photo"]
                     highlightedImage:[UIImage imageNamed:@"EaseUIResource.bundle/chatBar_colorMore_photo"]
                                title:@"相册"];

    _photoButton.accessibilityIdentifier = @"image";
    [_photoButton setFrame:CGRectMake(30*ratioWidth, 30, CHAT_BUTTON_SIZE.width , CHAT_BUTTON_SIZE.height)];
    ...
    [_locationButton setFrame:CGRectMake(30*ratioWidth + CHAT_BUTTON_SIZE.width*2 + 25*ratioWidth*2, 30, CHAT_BUTTON_SIZE.width , CHAT_BUTTON_SIZE.height)];
...
//    [_scrollview addSubview:_locationButton];
    ...
    _takePicButton = [self btnWithImage:[UIImage imageNamed:@"EaseUIResource.bundle/chatBar_colorMore_camera"]
                       highlightedImage:[UIImage imageNamed:@"EaseUIResource.bundle/chatBar_colorMore_cameraSelected"]
                                  title:@"拍照"];
    [_takePicButton setFrame:CGRectMake(30*ratioWidth + CHAT_BUTTON_SIZE.width + 25*ratioWidth, 30, CHAT_BUTTON_SIZE.width , CHAT_BUTTON_SIZE.height)];
...
- (UIButton *)btnWithImage:(UIImage *)aImage highlightedImage:(UIImage *)aHighLightedImage title:(NSString *)aTitle {
    ...
    [btn setTitleColor:HTColorFromRGB(0x888888) forState:UIControlStateNormal];
    btn.titleLabel.font = [UIFont systemFontOfSize: 12.0];
    btn.imageEdgeInsets = UIEdgeInsetsMake(-10, 0, 30, 0);
    btn.titleEdgeInsets = UIEdgeInsetsMake(30, -58, -20, 0);
    return btn;
}
