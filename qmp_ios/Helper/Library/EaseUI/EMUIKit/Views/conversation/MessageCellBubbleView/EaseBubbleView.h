...
extern CGFloat const EaseMessageCellPaddingTB;
...
@property(nonatomic,strong)UIImageView *imageShareView;

//a view
@property (nonatomic, strong) UILabel *msgLabel;
@property (nonatomic, strong) UIButton *okButton;
@property (nonatomic, strong) UIButton *noOkButton;
@property (nonatomic, strong) UIButton *grayButton;
@property (nonatomic, strong) UILabel *msg2Label;
@property (nonatomic, strong) UIImageView *bpiconView;
