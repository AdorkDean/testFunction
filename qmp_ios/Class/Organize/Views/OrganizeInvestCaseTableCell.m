...
- (UICollectionView *)collectionView {
    if (!_collectionView) {
        ...
        [_collectionView registerNib:[UINib nibWithNibName:@"OrganizeInvestCaseCollectionCell" bundle:nil] forCellWithReuseIdentifier:@"OrganizeInvestCaseCollectionCellID"];
