...
- (void)awakeFromNib {
    ...
    _productName.textColor = HTColorFromRGB(0x333333);
    _tzJigouLab.textColor = COLOR737782;
    _hangyeLab.textColor = H9COLOR;
    _bottomLabel.textColor = HTColorFromRGB(0x333333);
}
...
- (NSAttributedString *)fixSoso:(NSString *)soso {
    ...
    return [[NSAttributedString alloc] initWithString:soso?:@""
                                    attributes:@{NSFontAttributeName:_bottomLabel.font,
                                                 NSForegroundColorAttributeName:HTColorFromRGB(0x2D343A),
                                                 }];
}
- (NSAttributedString *)fixtime2:(NSString *)time {
    ...
    return [[NSAttributedString alloc] initWithString:time
                                           attributes:@{NSFontAttributeName:_bottomLabel.font, NSForegroundColorAttributeName:HTColorFromRGB(0x333333),}];
}
