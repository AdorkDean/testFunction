...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/MuPDF/platform/ios/iTunesArtwork2.png"
  install_resource "${PODS_ROOT}/MuPDF/platform/ios/x_alt_blue.png"
  install_resource "${PODS_ROOT}/MuPDF/platform/ios/x_alt_blue@2x.png"
